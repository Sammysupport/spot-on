...
<li> <b>Data at Rest Encryption:</b> Next to Data in Transition Encryption als all Saved Data at Rest is stored in encrypted containers: Authenticated and encrypted SQLite and PostgreSQL e.g. for URL databases ensure, that on the hard disc saved data is accessible only with password.</li>
